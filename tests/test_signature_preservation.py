...
class TestSignaturePreservation:
    """Test that fixture signatures are preserved when create_fixture is executed."""
    
    def test_function_fixture_with_dependencies_preserves_signature(self):
        ...
        class MockConfig:
            def __init__(self):
                self.fingest_fixture_path = "tests/data"
    ...
    def test_function_fixture_without_dependencies_preserves_signature(self):
    ...
    def test_class_fixture_signature_unchanged(self):
